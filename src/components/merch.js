  ...
  return (
    <div className="main">
      ...
      <p className="store">
        ...
        tempor incididunt ut labore et dolore magna aliqua. Aenean pharetra
        magna ac placerat vestibulum lectus mauris ultrices. Augue neque gravida
        in fermentum et. Pellentesque elit eget gravida cum. Feugiat sed lectus
        vestibulum mattis ullamcorper velit sed ullamcorper. Morbi quis commodo
        odio aenean sed adipiscing diam donec. Ligula ullamcorper malesuada
        proin libero nunc consequat interdum varius. Enim nunc faucibus a
        pellentesque sit amet porttitor. Sagittis vitae et leo duis. Venenatis
